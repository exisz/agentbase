...
- vibase stores Trello API credentials in environment variables (`TRELLO_KEY`, `TRELLO_TOKEN`)
- Credentials are never logged or transmitted except to configured vendor APIs
- The `.vibase/managed.yaml` file contains record IDs — treat it as non-sensitive metadata
